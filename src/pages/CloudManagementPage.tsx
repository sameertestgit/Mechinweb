...
import { Cloud, ArrowRight, Users, Settings, Shield, Zap } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <span>Get Management Quote</span>
                <ArrowRight className="h-5 w-5" />
              </Link>
              <a
                href="https://wa.me/15551234567?text=Hi%20Mechinweb,%20I%27m%20interested%20in%20cloud%20suite%20management%20services."
                target="_blank"
