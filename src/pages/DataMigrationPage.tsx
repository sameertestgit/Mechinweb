            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gray-900 rounded-2xl p-8 border border-gray-700">
                ...
                <p className="text-gray-400 mb-6">
                  Our migration process follows enterprise-grade security protocols and 
                  compliance standards to protect your sensitive data.
                </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/15551234567?text=Hi%20Mechinweb,%20I%27m%20interested%20in%20cloud%20data%20migration%20services."
                target="_blank"
