...
import { Shield, ArrowRight, CheckCircle, Clock, Mail, Users } from 'lucide-react';
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/20">
              <div className="max-w-md mx-auto">
                <div className="bg-gray-700/50 rounded-xl p-8 border border-cyan-500/50 text-center">
                  ...
                  <div className="text-5xl font-bold text-cyan-400 mb-6">$25<span className="text-lg text-gray-400">/setup</span></div>
